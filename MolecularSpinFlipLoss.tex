...
Feshbach molecules at the BEC-BCS crossover have been studied\s\cite{Greiner2003, Zwierlein2003, Jochim2003}, and ground state alkali dimers continue to progress\s\cite{Ni2008, Danzl2010, Takekoshi2014, Molony2014, Park2015, Guo2016, Liu2017, Rvachov2017};
KRb polar molecules have reached quantum degeneracy\s\cite{Moses2015}.
...
Direct cooling experiments begin at modest temperatures and require trap strengths typically only attained with quadrupole fields\s\cite{Weinstein1998, Sawyer2008, Riedel2011, Quintero-Perez2014, Akerman2017}.
...
The application of electric field without magnetic drives these parities further apart, note the zero magnetic field values in panels (b-c).
...
However when the molecule enters the antiparallel hemisphere, the magnitude of the quantization axis now decreases with increasing magnetic field.
%This molecule is thus magnetically strong field seeking and will be lost.
Thus the doubly stretched state is degenerate with a magnetically strong field seeking spin-flip partner state whenever the molecules cross the plane where \epb{}, leading to loss. %, at least in this intuitive first order picture.
