...
This follows by solving $H_\epbm(B)=\kappa$ to get the area of the contour in Fig.~\ref{fig:blocking}f and by solving the Landau-Zener formula to find $\kappa=\sqrt{\hbar \dot{H}}$, with $\dot{H}=2\mu_BB'v$ the rate of approach of approach of energy levels and $B'$ the trap gradient.
