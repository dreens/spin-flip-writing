...
\caption{
Surfaces where spin-flips can occur (\epb{}, $\mu_BB<d_EE$) are shown for three values of \bcl. The magnetic pins are shown as in Fig.~\ref{fig:CAD} for context. The very center of the trap is indicated; the cloud itself fits within about a $1\text{ mm}$ diameter.
\label{fig:LSurfs}}
\end{figure}
