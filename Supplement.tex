...
%At large enough $r$, $G(r,z)$ will behave as though no electric field were applied, since eventually the magnetic field will dominate over the electric.
%In this regime, $G(r,0)\propto\mu_\text{eff}B'r/2$. 
%This allows us to set the limit for validity of the expression:
%\begin{equation}
%(\frac{1}{2}\mu_\text{eff}B'r)^3\frac{\Delta^2}{(d_\text{eff}E)^4} \ll \mu_\text{eff}B'r/2
%\end{equation}
%Rearranging, this implies that:
%\begin{equation}
%\mu_\text{eff}B'r/2 \ll \frac{(d_\text{eff}E)^2}{\Delta}
%\end{equation}
